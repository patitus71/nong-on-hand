// lib/cronWindow.ts
//
// External scheduler (cron-job.org) ยิงมาทุก ~5-10 นาที และเวลาที่ยิงจริงอาจ
// คลาดเคลื่อนได้ (ไม่การันตีความแม่นยำระดับนาที) ดังนั้นการเทียบเวลาส่ง
// standup/EOD ต้องเทียบเป็น "ช่วง" (window) แทนการเทียบ HH:MM แบบตรงเป๊ะ
//
